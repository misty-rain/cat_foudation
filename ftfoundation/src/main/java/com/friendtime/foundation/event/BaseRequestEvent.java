...
public class BaseRequestEvent {
    ...
    public static final int REQUEST_PAYMENT_RECHARGE_CARDS_CONFIG_JSON = 57;
    ...
    public static final int REQUEST_GIFT_CONFIG_JSON = 50;

    public static final int REQUEST_BINDEMAIL_VERIFYCODE = 58;
    public static final int REQUEST_FACEBOOK_LOGIN = 59;
