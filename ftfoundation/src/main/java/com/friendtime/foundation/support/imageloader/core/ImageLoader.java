...
import com.friendtime.foundation.support.imageloader.core.assist.LoadedFrom;
import com.friendtime.foundation.support.imageloader.core.assist.ViewScaleType;
import com.friendtime.foundation.support.imageloader.core.imageaware.ImageAware;
import com.friendtime.foundation.support.imageloader.core.imageaware.ImageViewAware;
import com.friendtime.foundation.support.imageloader.core.imageaware.NonViewAware;
import com.friendtime.foundation.support.imageloader.core.listener.ImageLoadingListener;
import com.friendtime.foundation.support.imageloader.core.listener.ImageLoadingProgressListener;
import com.friendtime.foundation.support.imageloader.core.listener.SimpleImageLoadingListener;
import com.friendtime.foundation.support.imageloader.utils.ImageSizeUtils;
...
import com.friendtime.foundation.support.imageloader.utils.StorageUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.friendtime.foundation.support.imageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.friendtime.foundation.support.imageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.friendtime.foundation.support.imageloader.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.friendtime.foundation.support.imageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.friendtime.foundation.support.imageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
			...
			if (options.shouldShowImageForEmptyUri()) {
				if (options.getRoundDisplayer() != null) {
					...
					imageAware.setBackgroudDrawable(
							StorageUtils.drawableToBitmap(options.getImageForEmptyUri(configuration.resources)));
				}
			} else {
				if (options.getRoundDisplayer() != null) {
		...
		if (bmp != null && !bmp.isRecycled() && !needReDownload) {
			...
			if (options.shouldShowImageOnLoading()) {
				if (options.getRoundDisplayer() != null) {
					...
					imageAware.setBackgroudDrawable(
							StorageUtils.drawableToBitmap(options.getImageOnLoading(configuration.resources)));
				}
	 ...
	 * {@link com.friendtime.foundation.support.imageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.friendtime.foundation.support.imageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.friendtime.foundation.support.imageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.friendtime.foundation.support.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
