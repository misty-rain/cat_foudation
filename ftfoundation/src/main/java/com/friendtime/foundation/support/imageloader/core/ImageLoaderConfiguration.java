 ...
 *******************************************************************************/
package com.friendtime.foundation.support.imageloader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;
import com.friendtime.foundation.support.imageloader.cache.disc.DiskCache;
import com.friendtime.foundation.support.imageloader.cache.disc.naming.FileNameGenerator;
import com.friendtime.foundation.support.imageloader.cache.memory.MemoryCache;
import com.friendtime.foundation.support.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.friendtime.foundation.support.imageloader.core.assist.FlushedInputStream;
import com.friendtime.foundation.support.imageloader.core.assist.ImageSize;
import com.friendtime.foundation.support.imageloader.core.assist.QueueProcessingType;
import com.friendtime.foundation.support.imageloader.core.decode.ImageDecoder;
import com.friendtime.foundation.support.imageloader.core.download.ImageDownloader;
import com.friendtime.foundation.support.imageloader.core.process.BitmapProcessor;
import com.friendtime.foundation.support.imageloader.utils.L;
import com.friendtime.foundation.support.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.friendtime.foundation.support.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.friendtime.foundation.support.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.friendtime.foundation.support.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.friendtime.foundation.support.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.friendtime.foundation.support.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.friendtime.foundation.support.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.friendtime.foundation.support.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.friendtime.foundation.support.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.friendtime.foundation.support.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.friendtime.foundation.support.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.friendtime.foundation.support.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.friendtime.foundation.support.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.friendtime.foundation.support.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.friendtime.foundation.support.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
