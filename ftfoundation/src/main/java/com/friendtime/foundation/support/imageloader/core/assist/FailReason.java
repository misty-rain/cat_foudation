 ...
 *******************************************************************************/
package com.friendtime.foundation.support.imageloader.core.assist;
...
public class FailReason {
	...
	public static enum FailType {
		...
		DECODING_ERROR,
		/**
		 * {@linkplain com.friendtime.foundation.support.imageloader.core.ImageLoader#denyNetworkDownloads(boolean) Network
