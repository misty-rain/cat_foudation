...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.friendtime.foundation.support.imageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
