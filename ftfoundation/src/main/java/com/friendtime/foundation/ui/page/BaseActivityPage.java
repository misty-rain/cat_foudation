...
import com.friendtime.foundation.widget.ClearEditText;
...
public abstract class BaseActivityPage extends BasePage implements IViewListener {
    ...
    protected final <E extends View> E getView(String id) {
        try {
            return (E) pageView.findViewById(ReflectResourcer.getViewId(
                      context, id));
    ...
    protected void setTitle() {
        rlBackView = getView(FoundationResource.id.ft_foundation_sdk_float_account_manager_backLlId);
        tvTopic = getView(FoundationResource.id.ft_foundation_sdk_float_account_manager_titleTextViewId);
        btnTopicRight = getView(FoundationResource.id.ft_foundation_sdk_finish);
