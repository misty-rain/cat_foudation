...
public class ResourceNameCreator {
	...
	private final static String App_R_Java_Class_Name = "com.friendtime.foundation.R";
	private final static String Resource_Java_Pacgake_Name = "com.friendtime.foundation.utils";
	// 注意Resource_Java_Pacgake_Name要和路径要对应(当前的路径在workspace_loc:/Application/bin/classes,
	// 设置自己需要放置的路径，注意位置要与包名对应)
	private final static String Resource_Java_Path = "FoundationResource.java";
	private final static String Filter_Prefix_Name = "ft_foundation_sdk_";
