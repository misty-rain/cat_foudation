...
public class ClearEditText extends RelativeLayout implements TextWatcher,
    ...
    private void initWithAttrs(Context context, AttributeSet attrs) {
         ...
         */
        int[] array = ReflectResourcer.getStyleableArray(context,
                  FoundationResource.styleable.ft_foundation_sdk_clearEdit);
        int drawableId = 0;
        String warnTitle = "";
        if (array != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, array);
            drawableId = a.getResourceId(ReflectResourcer.getStyleable(
                      context, FoundationResource.styleable.ft_foundation_sdk_clearEdit_clear_src), 0);
            warnTitle = a.getString(ReflectResourcer.getStyleable(
                      context, FoundationResource.styleable.ft_foundation_sdk_clearEdit_warn_title));
            if (warnTitle == null) {
                warnTitle = "";
            }
        } else {
            drawableId = ReflectResourcer.getDrawableId(context, FoundationResource.drawable.ft_foundation_sdk_button_gray_close);
        }
        ...
        if (warnTitle.equals("")) {
            editText.setPadding((int) ((context.getResources().getDimension(ReflectResourcer.getDimenId(context, FoundationResource.dimen.ft_foundation_sdk_margin5)))), 0, 0, 0);
        } else {
            editText.setPadding((int) (warnTitle.length() * (context.getResources().getDimension(ReflectResourcer.getDimenId(context, FoundationResource.dimen.ft_foundation_sdk_font_size14)) + context.getResources().getDimension(ReflectResourcer.getDimenId(context, FoundationResource.dimen.ft_foundation_sdk_margin15)))), 0, 0, 0);
        }
        if (drawableId > 0) {
        ...
        params.setMargins((int) (context.getResources().getDimension(ReflectResourcer.getDimenId(context, FoundationResource.dimen.ft_foundation_sdk_margin15))), 0, 0, 0);
        ...
        params.setMargins(0, 0, (int) context.getResources().getDimension(ReflectResourcer.getDimenId(context, FoundationResource.dimen.ft_foundation_sdk_margin10)), 0);
